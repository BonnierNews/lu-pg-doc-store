...
function load(id, cb) {
  pgClient.query([
    "SELECT o.entity_id as id, entity_type as type, version_id, created as version_created, entity_created as created, attributes",
    "FROM entity o, entity_version ov",
    "WHERE o.latest_version_id = ov.version_id AND o.entity_id = $1"
  ].join(" "), [id], (err, res) => {
