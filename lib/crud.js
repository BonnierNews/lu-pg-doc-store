...
function load(id, cb) {
  pgClient.query([
    "SELECT e.entity_id as id, entity_type as type, version_id, created as version_created, entity_created as created, correlation_id, attributes",
...
function upsert(id, typeId, json, correlationId, done) {
...
function insertVersion(id, json, correlationId, done) {
  ...
  const params = [versionId, id, correlationId, json];
